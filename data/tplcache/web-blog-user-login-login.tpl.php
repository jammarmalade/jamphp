    ...
    <div class="center-block" style="width:300px;margin:20px;">
        ...
        <div class="checkbox">
            <label>
                <input type="checkbox" id="li_autologin" checked>自动登录
            </label>
            <a href="?m=blog&c=user&a=reg" class="pull-right">注册本站 >>></a>
        </div>
